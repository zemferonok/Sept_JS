...
//     if ((str.indexOf('@') + 2) >= str.lastIndexOf('.')) return false;
//     return true;
// }
// console.log(validator(testEmails[2]));
...
// - відсортувати масив "coursesArray" в спадаючому порядку за кількістю елементів в полі modules
